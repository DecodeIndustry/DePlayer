package com.example.decode.deplayer.service.notification
...
import com.example.decode.deplayer.general.PlayerUtil
...
class JcNotificationPlayer private constructor(private val context: Context) : JcPlayerManagerListener {
    ...
    fun createNotificationPlayer(title: String?, iconResourceResource: Int) {
        ...
        notification = NotificationCompat.Builder(context, NOTIFICATION_CHANNEL)
                ...
                .setSound(null)
                .setContentIntent(PendingIntent.getActivity(context, NOTIFICATION_ID, openUi, PendingIntent.FLAG_IMMUTABLE))
                .setAutoCancel(false)
                .build()
